...
**badcase 73 条已落 `data/badcases.json`**——这是 D10 反向注入的原料。
...
| 策略 | 样本数 | 平均 Δ均分 |
|---|---|---|
| precondition_injection | 133 | **【-18.57】** |
| constraint_tighten | 132 | **【-14.29】** |
| adversarial_escalation | 139 | **【-18.57】** |
| **整体** | **404** | **【-14.48】** |
